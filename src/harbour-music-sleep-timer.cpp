...
int main(int argc, char *argv[])
{
    ...
    if (!defaultLang->load("harbour-music-sleep-timer-en", TRANSLATION_INSTALL_DIR)) {
    ...
    if (!translator->load(QLocale(QLocale::system().name()), "harbour-music-sleep-timer", "-", TRANSLATION_INSTALL_DIR)) {
